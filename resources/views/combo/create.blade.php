...
@section('title', 'Cadastro Combos')

@section('content_header')
  <h1 class="text-center">Cadastrar Combos</h1>
@stop

@section('content')
  <div class="card card-info">
    <div class="card-header">
      <h3 class="card-title pl-5">Cadastro de Combos</h3>
    </div>

    <form class="form-horizontal" action="{{route('combo.store')}}" method="POST" enctype="multipart/form-data">
      @csrf
            @if(isset($id))
